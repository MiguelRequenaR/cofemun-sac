...
export default function HeroAbout() {
  return (
    <section
      className="relative w-full h-[60vh] min-h-[320px] flex items-center overflow-hidden"
    >
      ...
      <div className="relative z-10 flex flex-col items-center justify-end w-full h-full">
        ...
        <div className="w-full bg-primary/90" data-aos="fade-up" data-aos-delay="100">
          <p className="max-w-7xl mx-auto py-10 text-center text-white text-base md:text-lg">
            Contamos con un equipo con amplia experiencia en gestión de negocios internacionales, especializado en ofrecer soluciones de abastecimiento globales. Nuestra flexibilidad nos permite adaptarnos a las necesidades de nuestros clientes.
          </p>
        </div>
      </div>
    </section>
