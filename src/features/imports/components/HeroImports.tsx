      ...
      <div className="relative z-10 flex flex-col items-center justify-end w-full h-full">
        ...
        <div className="w-full bg-primary/90" data-aos="fade-up" data-aos-delay="100">
          <p className="max-w-7xl mx-auto py-10 text-center text-white text-base md:text-lg">
            Contamos con un equipo especialista, enfocado en la atención corporativa para Lima y Provincias. Nuestra flexibilidad operativa nos permite adaptar los cronogramas de entrega a las condiciones reales y tiempos críticos de tu proyecto.
          </p>
        </div>
      </div>
    </section>
