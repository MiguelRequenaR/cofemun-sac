    ...
    <section
      ...
      <div
        ...
        <div
          ...
          <div data-aos="zoom-in">
            <img src="https://images.unsplash.com/photo-1532635042-a6f6ad4745f9?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Importaciones" className="w-full h-full object-cover" />
          </div>
        </div>
      </div>
    </section >
