...
const services = [
  {
    ...
    description: "Amplio catálogo de suministros, abrasivos, sujeciones y consumibles diversos. Todo lo necesario para el mantenimiento diario y acabados de obra.",
  ...
  },
  {
    ...
    description: "Equipos de alto rendimiento para uso profesional. Desde taladros y amoladoras hasta herramientas manuales certificadas para garantizar precisión y seguridad.",
  ...
  },
  {
    ...
    description: "Especialistas en conducción de fluidos. Suministro de tuberías, válvulas y conexiones (PVC, CPVC, Acero) para proyectos sanitarios e industriales.",
  ...
  },
  {
    ...
    description: "Servicio de distribución integrado a tu compra. Coordinamos la entrega de tus materiales directamente en el punto de construcción para optimizar tus tiempos.",
