...
export default function HeroAbout() {
  return (
    ...
    >
      <img src="https://images.unsplash.com/photo-1497366811353-6870744d04b2?q=80&w=1469&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Hero About" className="absolute inset-0 w-full h-full object-cover" />
